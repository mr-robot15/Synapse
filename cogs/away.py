...
class Away:
                ...
                for author in tmp:
                    if author.id in self.data:
                        try:
                            ...
                            if self.data[author.id]['MESSAGE']:
                                msg = '{} is currently away and has set the following message: `{}` Dont fucking disturb him'.format(author.display_name, self.data[author.id]['MESSAGE'])
                            else:
    ...
    async def _away(self, context, *message: str):
        ...
        if author.id in self.data:
            ...
            msg = 'You\'re now back. Welcome again!'
        else:
            ...
            msg = 'You\'re now set as away. Cya bish!'
